...
const perks = [
  "Байгууллага дээр очиж хийдэг бүлгийн бясалгал",
  "Ажлын стресс, хурцадмал байдлыг тайлна",
  "Анхаарал төвлөрөл, бүтээмжийг нэмэгдүүлнэ",
  "8-20 хүний бүлгээр зэрэг оролцох боломжтой",
  "Тогтмол долоо хоног бүрийн хөтөлбөрөөр авах боломжтой",
  "Мэргэжлийн бясалгалын багш удирдана",
];
...
export default function MeditationPage() {
  ...
  return (
    <main>
      ...
      <section className="about-hero about-hero--meditation">
        <TypewriterText as="h1" text="Байгууллагын бясалгал" speed={48} startDelay={200} />
        <TypewriterText
          as="p"
          text="Стресс тайлж, бүтээмж нэмэх сонирхолтой хөтөлбөрт бүлгийн бясалгал."
          speed={20}
          startDelay={700}
        />
      </section>
      ...
      <section className="about-story">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://images.pexels.com/photos/3822622/pexels-photo-3822622.jpeg?auto=compress&cs=tinysrgb&w=900")',
        ...
        <div className="about-story-copy reveal" style={{ transitionDelay: "140ms" }}>
          <h2>Тухай</h2>
          <p>
            Ажлын байрны шахалт, стресс нь бүтээмж, сэтгэл ханамжид сөргөөр нөлөөлдөг. Манай
            байгууллагын бясалгалын хөтөлбөр нь хамт олонд тайван, төвлөрсөн сэтгэлгээ олгож, ажлын
            орчинд эерэг өөрчлөлт авчрахад чиглэдэг.
          </p>
          <p>
            Мэргэжлийн бясалгалын багш таны байгууллага дээр очиж, бүлгийн сессийг удирдана. Долоо
            хоног бүрийн тогтмол хөтөлбөр, эсвэл онцгой арга хэмжээнд зориулсан нэг удаагийн сесс
            хэлбэрээр захиалах боломжтой.
          </p>
        </div>
      </section>
      ...
      <section className="about-cta reveal">
        <h2>Байгууллагын бясалгалаа захиалаарай</h2>
        <p>Нэг удаагийн үнэ 50,000₮. Танд тохирох цагийг сонгоод шууд захиална уу.</p>
