...
const perks = [
  "Хувь хүн, эсвэл бүлгээр авах боломжтой сургалт",
  "Өдөр тутмын хоолны дэглэм зохион байгуулахад тусална",
  "Эрүүл жин барих, илчлэг тооцох мэдлэг олгоно",
  "Байгууллагын хамт олонд зориулсан бүлгийн хөтөлбөр",
  "Мэргэжлийн хоол зүйчийн ганцаарчилсан зөвлөгөө",
  "Тогтмол хяналт, дэвшил хянах дэмжлэг",
];
      ...
      <section className="about-story">
        ...
        <div className="about-story-copy">
          ...
          <p>
            ...
            өдөр тутмын хоолны дэглэмээ зөв төлөвлөх, илчлэг тооцох, эрүүл жин барих мэдлэг олгоход
            чиглэдэг.
          </p>
          <p>
            Байгууллагын хамт олонд зориулсан бүлгийн хөтөлбөр, эсвэл хувь хүний онцлогт тохирсон
            ганцаарчилсан зөвлөгөөгөөр авах боломжтой. Мэргэжлийн хоол зүйч таны зорилго, эрүүл мэндийн
            байдалд тулгуурлан дэглэм зохион байгуулж өгнө.
          </p>
        </div>
      </section>
