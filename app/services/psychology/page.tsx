...
const perks = [
  "Мэргэжлийн сэтгэл зүйчийн ганцаарчилсан, бүлгийн зөвлөгөө",
  "Стресс, түгшүүр, сэтгэл гутралтай ажиллах дадал олгоно",
  "Ажлын байрны харилцаа, зөрчил зохицуулах ур чадвар сургана",
  "Байгууллагын хамт олонд зориулсан бүлгийн сургалт",
  "Нууцлал баталгаатай, тав тухтай орчинд явагдана",
  "Тогтмол сарын хөтөлбөр эсвэл нэг удаагийн уулзалт",
];
...
export default function PsychologyPage() {
  ...
  return (
    <main>
      ...
      <section className="about-hero about-hero--psychology">
        <TypewriterText as="h1" text="Сэтгэл зүйн сургалт" speed={50} startDelay={200} />
        <TypewriterText
          as="p"
          text="Мэргэжлийн сэтгэл зүйчийн бүлгийн сургалт, зөвлөгөө."
          speed={22}
          startDelay={700}
        />
      </section>
      ...
      <section className="about-story">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://images.pexels.com/photos/7176026/pexels-photo-7176026.jpeg?auto=compress&cs=tinysrgb&w=900")',
        ...
        <div className="about-story-copy reveal" style={{ transitionDelay: "140ms" }}>
          <h2>Тухай</h2>
          <p>
            Сэтгэл зүйн эрүүл мэнд нь бие махбодийн эрүүл мэндтэй адил чухал. Манай сэтгэл зүйн сургалт
            нь стресс, түгшүүр, ажлын шаталтыг даван туулах дадал олгож, сэтгэл санааны тэнцвэрийг
            хадгалахад тусална.
          </p>
          <p>
            Мэргэжлийн сэтгэл зүйч ганцаарчилсан зөвлөгөө, эсвэл байгууллагын хамт олонд зориулсан
            бүлгийн сургалтаар ажилладаг. Бүх уулзалт нууцлал баталгаатай, тайван орчинд явагдана.
          </p>
        </div>
      </section>
      ...
      <section className="about-cta reveal">
        <h2>Сэтгэл зүйн сургалтаа захиалаарай</h2>
        <p>Нэг удаагийн үнэ 45,000₮. Танд тохирох цагийг сонгоод шууд захиална уу.</p>
